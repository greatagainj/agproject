...
public class AttrAttrgroupRelationController {
    ...
    public Resp<Object> deleteAttrRelation(@RequestBody List<AttrAttrgroupRelationEntity> relationEntityList) {
        this.attrAttrgroupRelationService.deleteAttrRelation(relationEntityList);
        return Resp.ok("删除成功");
    }
