...
public class MemberReceiveAddressController {
    ...
    public Resp<List<MemberReceiveAddressEntity>> queryAddressesByUserId(@PathVariable("userId")Long userId) {
        ...
        List<MemberReceiveAddressEntity> memberReceiveAddressEntityList =
                this.memberReceiveAddressService.list(new QueryWrapper<MemberReceiveAddressEntity>()
                        .eq("member_id", userId));

        return Resp.ok(memberReceiveAddressEntityList);
    }
